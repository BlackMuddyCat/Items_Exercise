...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "dE2z_mniKpvkcwrBIcrFmzGD5x5ooqmlYOJUjp_R";
    private static final String SECRETKEY = "kfGEvybt3jxEbCyZxHkapAZMe2L4B5AYoRVmrvVV";
    private static final String BUCKET = "ordering-physical-examination";
    public static final String DOMAIN= "http://qh6y8ah4p.hn-bkt.clouddn.com/";
